...
function About() {
  return (
    <Container className={styles.Content}>
      ...
      <hr />
      <p>
        Here at The Red Crayon, we pride ourselver on catering to the Art
        community.
      </p>
      <p>
        We strive to provide you the lasted News on the art scene, as well as a
        list of all the upcoming, MUST SEE events.
      </p>
      <p>
        ...
        and tell us all exactly what you&apos;re working on, as well as what external
        triggers are fueling your creativity, such as the music you&apos;re listening
        to.
      </p>
      <p>
        Users can follow each other, like each others posts, and leave a
        friendly comment should they wish. Tying together that feeling of
        &quot;togetherness&quot; we all crave so much.
      </p>
